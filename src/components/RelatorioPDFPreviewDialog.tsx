...
import { RelatorioPrintTemplate } from "./RelatorioPrintTemplate";

interface RelatorioPDFPreviewDialogProps {
  open: boolean;
  onClose: () => void;
  onPrint: () => void;
  printData: any;
...
export function RelatorioPDFPreviewDialog({
  open,
  onClose,
  onPrint,
  printData,
  isGenerating,
}: RelatorioPDFPreviewDialogProps) {
      ...
      <DialogContent className="max-w-[95vw] max-h-[95vh] p-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b bg-gray-100">
          <h2 className="text-lg font-bold">
            Pré-visualização - Relatório de Movimentações
          </h2>
